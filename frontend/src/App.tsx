...
export default function App() {
  const { step, setStep, captureFile, policy, error, clearError, initSession, findings, analysisSummary, analysisMetadata, isAnalyzing, dismissFinding } = useStore();
            ...
            <div className="card">
              ...
              {captureFile?.summary && (
                <div className="mt-3 pt-3 border-t border-gray-800 text-xs text-gray-500 space-y-1">
                  ...
                  <p>⏱ {captureFile.summary.durationSeconds}s duration</p>
                </div>
              )}
