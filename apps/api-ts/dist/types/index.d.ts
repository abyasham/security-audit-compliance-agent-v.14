...
export interface StreamAnomaly {
    type: 'retransmission' | 'rst' | 'zero-window' | 'tls-alert' | 'http-error' | 'timeout' | 'duplicate-ack' | 'out-of-order' | 'malformed' | 'fragment' | 'checksum-error' | 'suspicious-flags' | 'icmp-error';
    count: number;
    description: string;
    packetNumbers: number[];
}
export type PolicyCategory = 'encryption' | 'network-segmentation' | 'access-control' | 'protocol-compliance' | 'authentication' | 'logging' | 'data-exfiltration';
export type Severity = 'critical' | 'high' | 'medium' | 'low' | 'info';
export type ComparisonOp = 'equals' | 'notEquals' | 'greaterThan' | 'lessThan' | 'contains' | 'notContains' | 'in' | 'notIn' | 'inZone' | 'matches';
