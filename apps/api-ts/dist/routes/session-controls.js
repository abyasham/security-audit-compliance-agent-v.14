...
exports.sessionControlsRouter.post('/clear/:sessionId', (req, res) => {
    try {
        const { sessionId } = req.params;
        const session = store.getSession(sessionId);
        if (!session) {
...
exports.sessionControlsRouter.delete('/:sessionId', (req, res) => {
    try {
        const { sessionId } = req.params;
        const session = store.getSession(sessionId);
        if (!session) {
...
exports.sessionControlsRouter.get('/memory/:sessionId', (req, res) => {
    try {
        const { sessionId } = req.params;
        const session = store.getSession(sessionId);
        if (!session) {
...
exports.sessionControlsRouter.post('/compact/:sessionId', (req, res) => {
    try {
        const { sessionId } = req.params;
...
//# sourceMappingURL=session-controls.js.map